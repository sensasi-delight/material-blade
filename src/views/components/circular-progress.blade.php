...
<div
    ...
    <div class="mdc-circular-progress__determinate-container">
        <svg class="mdc-circular-progress__determinate-circle-graphic" viewBox="{{ $viewBox }}"
            ...
            <circle class="mdc-circular-progress__determinate-track" {!! $cx !!}
                stroke-width="{{ $strokeWidth }}" />
            <circle class="mdc-circular-progress__determinate-circle" {!! $cx !!}
                stroke-dasharray="{{ $strokeDasharray }}" stroke-dashoffset="{{ $strokeDasharray }}"
                stroke-width="{{ $strokeWidth }}" />
        </svg>
    </div>
